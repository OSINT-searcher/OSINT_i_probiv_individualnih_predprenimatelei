...
|----------|------------------------------------------------------------------|----------------------------------------|
|📲🪙🆓| [Sherlock](https://t.me/Fyijkopouh_huukbhh_bot?start=_ref_9pyalm_JJwlz5)| Универсальный и **крупнейший** бот для пробива информации по ИП и другим данным.|
|📲♻️🆓| [Vektor](https://t.me/Bigibik_bot?start=r_eFGr1BT2b5)| Бот для анализа по базам данных, умеющий проверять ИНН и прочие юридические данные.|
...
* Откройте бесплатный [Официальный кошелек](https://t.me/wallet/start?startapp=ref-1-g__tgEbYk3k) или [Телеграм кошелек Crypto Bot](https://t.me/send?start=r-ezc61), купите крипту с помощью карты банка и именно криптой пополняйте балансы ботов.
...
* Оценка деловой репутации - посмотреть, нет ли судебных дел, долгов или жалоб клиентов. Актуально при частых закупках, для [проверки продавцов](https://github.com/OSINT-searcher/OSINT_i_probiv_Prodavca).
